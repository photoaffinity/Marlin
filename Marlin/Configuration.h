...
#define STRING_CONFIG_H_AUTHOR "(JonMann, MARLIN 2 BUGFIX Ender-5+Bltouch+SKR1.4Turbo+3.5TFT E3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Build 0.1"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -6, -2.65 }
